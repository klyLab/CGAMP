...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_data_path', type=str,
                        default='./data_processed/multi_test/stage-2 test dataset.pt',
                        help='Path to multi-class independent test .pt file (converted from FASTA, default: ./data_processed/multi_test/stage-2 test dataset.pt)')
    parser.add_argument('--model_dir', type=str,
                        default='./trained_models/multiclass_model/model',
                        help='Directory of pre-trained multi-class models (download from README, default: ./trained_models/multiclass_model/model)')
